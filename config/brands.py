...
BRANDS: Dict[str, BrandConfig] = {
    ...
    "americantourister": BrandConfig(True,"americantourister","AMERICAN TOURISTER","americantourister.com.au","au/en","https://www.americantourister.com.au/sitemap_index.xml",r"sitemap_0-product\.xml$",r"^https://www\.americantourister\.com\.au/.+?/([A-Za-z0-9\-]+(?:/[A-Za-z0-9\-]+)?(?:/[A-Za-z0-9\-]+)?)\.html$","jsonld",False,False),
    ...
    "highsierra": BrandConfig(True,"highsierra","HIGH SIERRA","highsierra.com.au","au/en","https://www.highsierra.com.au/sitemap_index.xml",r"sitemap_0-product\.xml$",r"^https://www\.highsierra\.com\.au/.+?/([A-Za-z0-9\-]+)\.html$","jsonld",False,False),
    ...
    "victorinox": BrandConfig(True,"victorinox","VICTORINOX","victorinox.com","en","https://www.victorinox.com/sitemap/en.xml",r"/sitemap/dynamic/en\.xml$",r"^https://www\.victorinox\.com/(?:en|en-AU)/Products/(?:Travel-Gear|Bags-Travel-Gear)/.+/p/([^/?#]+)/?$","jsonld",False,False,seed_urls=["https://www.victorinox.com/en/Products/Travel-Gear/c/TRG/"]),
